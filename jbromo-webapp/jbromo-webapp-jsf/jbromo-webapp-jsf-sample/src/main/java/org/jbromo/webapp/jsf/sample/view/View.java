...
public enum View implements IView {
    ...
    COMMAND_BUTTON("/button/commandButtonView.xhtml",
            CommandButtonController.class),
    /** The countries view. */
    COUNTRIES("/country/country.xhtml", CountryController.class),
    /** The dynamicTabPanel view. */
    DYNAMIC_TAB_PANEL("/layer/dynamicTabPanelView.xhtml",
            DynamicTabPanelController.class),
    /** The togglePanel view. */
    TOGGLE_PANEL("/layer/togglePanelView.xhtml",
            TogglePanelControllerView.class),
    /** The togglePanel view. Notes viewId is set to view */
    TOGGLE_PANEL_WIZARD(TOGGLE_PANEL.getId(),
            TogglePanelController.class),
    ...
    TOGGEL_PANEL_SECOND_ITEM("secondItem",
            SecondTogglePanelItemController.class),
    ...
    WIZARD_FIRST_ITEM("/layer/wizardFirstItemView.xhtml",
            FirstWizardItemController.class),
    /** The wizard second item view. */
    WIZARD_SECOND_ITEM("/layer/wizardSecondItemView.xhtml",
            SecondWizardItemController.class),
    /** The wizard first item view. */
    WIZARD_THIRD_ITEM("/layer/wizardThirdItemView.xhtml",
            ThirdWizardItemController.class),
    /** The dataScroller view. */
    DATASCROLLER("/layer/dataScrollerView.xhtml", DataScrollerController.class),
    /** The datatable view. */
    ROWCLICK_DATATABLE("/layer/rowClickDataTableView.xhtml",
            RowClickDataTableController.class),
    /** The datatable view. */
    SELECTALL_DATATABLE("/layer/selectAllDataTableView.xhtml",
            SelectAllDataTableController.class),
    /** The datatable view. */
    CRUD_DATATABLE("/layer/crudDataTableView.xhtml",
            CrudDataTableController.class),
    /** The datatable view. */
    HEADER_DATATABLE("/layer/headerDataTableView.xhtml",
            ColumnHeaderDataTableController.class),
    /** The fieldset view. */
    FIELDSET("/layer/fieldSetView.xhtml", null),
    /** The input text view. */
    INPUT_TEXT("/input/inputTextView.xhtml", InputTextController.class),
    /** The input text view. */
    INPUT_TEXTAREA("/input/inputTextareaView.xhtml",
            InputTextareaController.class),
    /** The countries view. */
    LANGUAGES("/language/language.xhtml", LanguageController.class),
    /** The messageLabel view. */
    MESSAGE_LABEL("/message/messageLabelView.xhtml",
            MessageLabelController.class),
    /** The popupWait view. */
    ...
    SELECT_ONE_MENU("/select/selectOneMenuView.xhtml",
            SelectOneMenuController.class),
    /** The selectBooleanMenu view. */
    SELECT_BOOLEAN_MENU("/select/selectBooleanMenuView.xhtml",
            SelectBooleanMenuController.class),
    /** The selectManyCheckbox view. */
    SELECT_MANY_CHECKBOX("/select/selectManyCheckboxView.xhtml",
            SelectManyCheckboxController.class);
