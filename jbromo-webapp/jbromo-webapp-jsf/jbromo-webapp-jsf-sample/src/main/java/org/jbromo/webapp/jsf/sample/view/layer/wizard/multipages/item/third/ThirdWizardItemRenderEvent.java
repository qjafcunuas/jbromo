 ...
 */
@Getter
public class ThirdWizardItemRenderEvent extends
        AbstractWizardItemRenderEvent<ThirdWizardItemRenderData> {
     ...
     */
    public ThirdWizardItemRenderEvent(
            final AbstractWizardItemNextEvent<? extends Serializable> nextEventSent,
            final ThirdWizardItemRenderData data) {
